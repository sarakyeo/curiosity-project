...
\caption{Standardized regression coefficients and standard errors (in parentheses) followed by p-values in the OLS regression models predicting situational curiosity, and intentions to engage in dialogue about the search for life in the universe.}
 \label{tab:OLS-model}
